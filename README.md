...
**2026/8/13**
- Add 1 paper: StructureGS

**2026/8/12**
- Add 12 papers: CAP-Net, ArtVIP, ArticulatedGS, IAAO, iTACO, SPLATART, Infinite Mobility, DIPO, FreeArt3D, RigGS, LARM, and Articulated Object Understanding from a Single Video Sequence
...
### 1. Survey on Modeling of Human-made Articulated Objects
*Liu et al., Computer Graphics Forum 2025*

[📄 Paper](https://doi.org/10.1111/cgf.70092)
<details span>
...
### 1. CAP-Net: A Unified Network for 6D Pose and Size Estimation of Categorical Articulated Parts from a Single RGB-D Image
*CAP-Net, CVPR 2025*

[📄 Paper](https://arxiv.org/abs/2504.11230)
- Level: Category-Level
- Dataset: RGBD-Art
...
### 2. CAPT: Category-level Articulation Estimation from a Single Point Cloud Using Transformer
*CAPT, ICRA 2024*
...
### 3. MARS: Multimodal Active Robotic Sensing for Articulated Characterization
*MARS, IJCAI 2024*
...
### 4. OP-Align: Object-level and Part-level Alignment for Self-supervised Category-level Articulated Object Pose Estimation
*OP-Align, ECCV 2024*
...
### 5. Building Rearticulable Models for Arbitrary 3D Objects from 4D Point Clouds
*Liu et al., CVPR 2023*
...
### 6. Category-Level Articulated Object 9D Pose Estimation via Reinforcement Learning
*ArtPERL, MM 2023*
...
### 7. Towards Real-World Category-level Articulation Pose Estimation
*CAPER, TIP 2022*
...
### 8. Unsupervised Kinematic Motion Detection for Part-segmented 3D Shape Collections
*UKMD, SIGGRAPH 2022*
...
### 9. Distributional Depth-Based Estimation of Object Articulation Models
*DUST-Net, CoRL 2021*
...
### 10. ScrewNet: Category-Independent Articulation Model Estimation From Depth Images Using Screw Theory
*ScrewNet, ICRA 2021*
...
### 11. Nothing But Geometric Constraints: A Model-Free Method for Articulated Object Pose Estimation
*GC-Pose, arXiv 2020*
...
### 12. Category-Level Articulated Object Pose Estimation
*ANCSH, CVPR 2020*
...
### 13. RPM-Net: Recurrent Prediction of Motion and Parts from Point Cloud
*RPM-Net, ToG 2019*
...
### 14. Learning to Generalize Kinematic Models to Novel Objects
...
### 1. ArtVIP: Articulated Digital Assets of Visual Realism, Modular Interaction, and Physical Fidelity for Robot Learning
*ArtVIP, ICLR 2026*

[📄 Paper](https://arxiv.org/abs/2506.04941) | [🌐 Project Page](https://x-humanoid-artvip.github.io/)
- Dataset: ArtVIP
<details span>
<summary><b>Abstract</b></summary>
<br>
...
### 2. RoCap: A Robotic Data Collection Pipeline for the Pose Estimation of Appearance-Changing Objects
*RoCap, arXiv 2024*
...
### 3. ParaHome: Parameterizing Everyday Home Activities Towards 3D Generative Modeling of Human-Object Interactions
*ParaHome, arXiv 2024*
...
### 4. AO-Grasp: Articulated Object Grasp Generation
*AO-Grasp, arXiv 2023*
...
### 5. MultiScan: Scalable RGBD scanning for 3D environments with articulated objects
*MultiScan, NIPS 2022*
...
### 6. AKB-48: A real-world articulated object knowledge base
*AKB-48, CVPR 2022*
...
### 7. SAPIEN: A simulated part-based interactive environment
*SPAIEN, CVPR 2020*
...
### 8. Shape2Motion: Joint Analysis of Motion Parts and Attributes from 3D Shapes
...
### 9. The RBO Dataset of Articulated Objects and Interactions
*RBO, IJRR 2019*
...
### 10. 3D Shape Segmentation with Projective Convolutional Networks
*ShapePFCN, CVPR 2017*
...
*StructureGS, ECCV 2026*

[📄 Paper](https://arxiv.org/abs/2607.26889)
- Level: Category-Agnostic
- Dataset: PARIS, DTA-Multi, ArtGS-Multi
- Input: Multi-view RGB Images in Two States
<details span>
<summary><b>Abstract</b></summary>
<br>
...
### 2. REArtGS: Reconstructing and Generating Articulated Objects via 3D Gaussian Splatting with Geometric and Motion Constraints
*REArtGS, arXiv 2025*
...
### 3. ArticulatedGS: Self-supervised Digital Twin Modeling of Articulated Objects using 3D Gaussian Splatting
*ArticulatedGS, CVPR 2025*

[📄 Paper](https://arxiv.org/abs/2503.08135)
- Level: Category-Agnostic
- Input: Two Sets of Multi-view RGB Images
<details span>
<summary><b>Abstract</b></summary>
<br>
...
### 4. IAAO: Interactive Affordance Learning for Articulated Objects in 3D Environments
*IAAO, CVPR 2025*

[📄 Paper](https://arxiv.org/abs/2504.06827)
- Level: Category-Agnostic
- Input: Multi-view RGB Images in Multiple States
<details span>
<summary><b>Abstract</b></summary>
<br>
...
### 5. iTACO: Interactable Digital Twins of Articulated Objects from Casually Captured RGBD Videos
*iTACO, arXiv 2025*

[📄 Paper](https://arxiv.org/abs/2506.08334) | [🌐 Project Page](https://3dlg-hcvc.github.io/video2articulation/)
- Level: Category-Agnostic
- Dataset: iTACO
- Input: RGB-D Video
<details span>
...
### 8. Real2Code: Reconstruct Articulated Objects via Code Generation
...
### 9. RoboStudio: A Physics Consistent World Model for Robotic Arm with Hybrid Representation
...
### 10. DexSim2Real2: Building Explicit World Model for Precise Articulated Object Dexterous Manipulation
...
### 11. ACDC: Automated Creation of Digital Cousins for Robust Policy Learning
*ACDC, CoRL 2024*
...
### 12. Articulate-Anything: Automatic Modeling of Articulated Objects via a Vision-Language Foundation Model
...
### 13. PARIS: Part-level Reconstruction and Motion Analysis for Articulated Objects
*PARIS, ICCV 2023*
...
### 14. Building Digital Twins of Articulated Objects and Scenes through Interactive Perception
*Ditto, Thesis*
...
- Level: Category-Agnostic
- Input: RGB Images in Multiple States
<details span>
<summary><b>Abstract</b></summary>
<br>
...
### 1. RigGS: Rigging of 3D Gaussians for Modeling Articulated Objects in Videos
*RigGS, CVPR 2025*

[📄 Paper](https://arxiv.org/abs/2503.16822)
- Level: Category-Agnostic
...
### 2. SM$^3$: Self-Supervised Multi-task Modeling with Multi-view 2D Images for Articulated Objects
*SM$^3$, arXiv 2024*
...
### 3. Knowledge NeRF: Few-shot Novel View Synthesis for Dynamic Articulated Objects
...
### 4. Neural Implicit Representation for Building Digital Twins of Unknown Articulated Objects
...
### 5. REACTO: Reconstructing Articulated Objects from a Single Video
*REACTO, CVPR 2024*
...
### 7. NARF24: Estimating Articulated Object Structure for Implicit Rendering
*NARF24, arXiv 2024*
...
### 9. CARTO: Category and Joint Agnostic Reconstruction of ARTiculated Objects
*CARTO, CVPR 2023*
...
### 10. NAISR: A 3D Neural Additive Model for Interpretable Shape Representation
*NAISR, arXiv 2023*
...
### 12. Template-free Articulated Neural Point Clouds for Reposable View Synthesis
...
### 13. Ditto: Building Digital Twins of Articulated Objects from Interaction
*Ditto, CVPR 2022*
...
### 14. CLA-NeRF: Category-Level Articulated Neural Radiance Field
*CLA-NeRF, ICRA 2022*
...
### 15. Watch It Move: Unsupervised Discovery of 3D Joints for Re-Posing of Articulated Objects
...
### 16. Self-supervised Neural Articulated Shape and Appearance Models
*NASAM, CVPR 2022*
...
### 17. NARF22: Neural Articulated Radiance Fields for Configuration-Aware Rendering
*NARF22, IROS 2022*
...
### 18. Unsupervised Pose-Aware Part Decomposition for 3D Articulated Objects
*PPD, ECCV 2021*
...
### 19. A-SDF: Learning Disentangled Signed Distance Functions for Articulated Shape Representation
*A-SDF, ICCV 2021*
...
### 20. StrobeNet: Category-Level Multiview Reconstruction of Articulated Objects
...
### 3. CenterArt: Joint Shape Reconstruction and 6-DoF Grasp Estimation of Articulated Objects
...
### 4. Detection Based Part-level Articulated Object Reconstruction from Single RGBD Image
...
### 5. Interaction-Driven Active 3D Reconstruction with Object Interiors
*YAN et al., ToG 2023*
